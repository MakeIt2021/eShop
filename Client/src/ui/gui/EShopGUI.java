...
public class EShopGUI extends JFrame {
    ...
    public EShopGUI() throws IOException {
        ...
        mitarbeiterMainPanel.getSucheField().getDocument().addDocumentListener(new DocumentListener() {
        ...
        kundenPanel.getSucheField().getDocument().addDocumentListener(new DocumentListener() {
